                ...
                <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-3 pl-4 border-l border-slate-200">
                            ...
                            <button onClick={handleLogout} title="Logout" className="ml-2 text-slate-400 hover:text-indigo-600 transition-colors">
                    ...
                    <div className="flex-1">
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-6">
                                ...
                                <span className="bg-indigo-50 text-indigo-700 text-xs font-bold px-2 py-0.5 rounded-full">{jobs.length}</span>
                            </div>
                                        ...
                                        <div key={job.id} className="group bg-white rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition-all p-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                                            <div className="flex-1">
                                                <div className="flex items-center gap-3 mb-1">
                                                    ...
                                                    <span className={`px-2.5 py-0.5 rounded text-xs font-semibold ${job.experienceLevel === 'Fresher' ? 'bg-emerald-50 text-emerald-700' : job.experienceLevel === 'Mid' ? 'bg-amber-50 text-amber-700' : 'bg-purple-50 text-purple-700'}`}>
                                            ...
                                            <button
                                                ...
                                                className="w-full sm:w-auto bg-slate-900 text-white px-5 py-2.5 rounded-lg text-sm font-medium hover:bg-black transition-colors flex items-center justify-center gap-2 shadow-sm shadow-slate-200"
                                            >
