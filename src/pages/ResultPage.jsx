                        ...
                        <div className={`p-10 rounded-[3rem] border shadow-2xl transition-all relative overflow-hidden ${isPass
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="flex flex-wrap gap-4">
                                    ...
                                    <button className="px-8 py-4 bg-white dark:bg-slate-800 rounded-2xl text-[10px] font-black uppercase tracking-widest text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-slate-700">
